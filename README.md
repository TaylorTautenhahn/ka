...
- `DB_PATH` (default `<DATA_ROOT>/recruitment.db`)
- `UPLOADS_DIR` (default `<DATA_ROOT>/uploads`)
...
- `ALLOWED_HOSTS` (default `localhost,127.0.0.1,::1`; set explicit production hostnames)
- `ENFORCE_CSRF` (default `1`)
